...
export const pedagogiqueApi = {
  ...
  createCourse: (payload, onUploadProgress) => api.post('/pedagogique/courses/', payload, { onUploadProgress }),
  updateCourse: (id, payload) => api.patch(`/pedagogique/courses/${id}/`, payload),
  deleteCourse: id => api.delete(`/pedagogique/courses/${id}/`),
  assignProfessor: (id, professor_id) => api.post(`/pedagogique/courses/${id}/assign_professor/`, { professor_id }),
  removeProfessor: (id, professor_id) => api.post(`/pedagogique/courses/${id}/remove_professor/`, { professor_id }),
...
export const assignmentsApi = {
  ...
  submitGroupLink: (id, payload, onUploadProgress) => api.post(`/assignments/groups/${id}/submit_link/`, payload, { onUploadProgress }),
